...
import PauseSiteButton from '@/app/admin/clients/PauseSiteButton'
import ReminderActionButton from '@/app/admin/dashboard/ReminderActionButton'
import OffboardingChecklist from '@/app/admin/clients/OffboardingChecklist'
import ChurnClientButton from '@/app/admin/clients/ChurnClientButton'
...
export default async function ClientDetailView({ clientId, orgSlug }: ClientDetailViewProps) {
  const id = clientId
  const slug = orgSlug
